...
//右上边退出按钮点击触发 create by LEZ  16/9/23
@protocol SLPagingDelegate <NSObject>
...
@property (nonatomic,assign)id<SLPagingDelegate>delegate;
...
@property (nonatomic,strong) UIImageView *lastBarRightItemImageV;
